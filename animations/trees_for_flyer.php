...
<html>
  ...
  <script>
    ...
    let mc = 1
    canvas2.height = 1920 * mc
    canvas2.width = 1080 * mc
    ...
    Draw = () => {
      ...
      s=200,r=200
      g=x.createRadialGradient(c.width-s*1,400+s,0,c.width-s,400+s,r),g[l](0,'#ffe'),g[l](.2,'#ffe'),g[l](1,'#fff0'),x.fillStyle=g
      x.beginPath(),x.arc(c.width-s*1,400+s,r,0,7),x.fill();
      ...
      x.lineTo(0,h)
      x.fill()
      x.drawImage(cloud,-50,450,cloud.width/6, cloud.height/6)
      x.drawImage(cloud, 100,250,cloud.width/4, cloud.height/4)
      ...
      treeCt = 8
      for(m=treeCt;m--;)T(c.width/treeCt*m+c.width/treeCt/2,c.height+(((m+20)**5.9%1100)-700))
