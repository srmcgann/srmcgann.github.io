...
function initVars(){
	...
	for(i=1;i<=10;++i){
		sparkPic=new Image();
		sparkPic.src="spark"+i+".png";
		sparkPics.push(sparkPic);
	}
	sparks=new Array();
	pow1=new Audio("pow1.ogg");
	pow2=new Audio("pow2.ogg");
	pow3=new Audio("pow3.ogg");
	pow4=new Audio("pow4.ogg");
...
function splode(x,y,z){
	...
	switch(parseInt(Math.random()*4)){
		case 0:	pow=new Audio("pow1.ogg"); break;
		case 1:	pow=new Audio("pow2.ogg"); break;
		case 2:	pow=new Audio("pow3.ogg"); break;
		case 3:	pow=new Audio("pow4.ogg"); break;
	}
